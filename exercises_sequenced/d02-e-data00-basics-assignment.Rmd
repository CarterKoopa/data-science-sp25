...
Cut is the quality of the diamond cut (fair, good, very good, etc),
color is the diamond color, and clarity is a measurement of how clear
the diamonds are. This set contains \~54,000 round-cut diamonds and
...
-   This dataset is describing the characteristics of cut diamonds
    including information on their physical size, characteristics, and
    quality.
-   Carat seems to be fairly well grouped around smaller numbers,
    however, there are a few very large carat outliers (most \<1, but
    the max is 5. Price varies in this same pattern, as does size.
-   Depth table remain closer together.
-   Cut, color, and clarity are distributed in roughly the same way.

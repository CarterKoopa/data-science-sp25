...
diamonds %>%
  ...
  mutate(carat_cut = cut_interval(carat, 4)) %>% 
...
-   The lowest carat cut grouping is interesting - it has a significantly lower mean and upper/lower quartile, but has many many more outliers compared to the other groups. The other groups have decreasing whiskers and roughly decreasing quartiles as the carat increases. The median becomes more centered between the quartiles as you advice up.

...
This hypothesis is NOT correct - in fact, there's more ideal diamonds than each of the other diamond cuts individually. As quality increases, so does quantity.
...
This graph is not effective - it fundamentally doesn't show any difference between the cuts when, as our other graphs and simple checks have, they are very different.
...
This hypothesis doesn't hold up here. The medians are fairly close in median price, and if anything, the upper quartile on the ideal diamonds is lower than all other cuts.
...
This hypothesis seems to be holding true. The median and outlier carat values are highest for the lowest quality cut, fair, while ideal cut diamonds have the lowest carat value. The box plot doesn't do a great job displaying quantity of diamonds of each cut, which would be useful, although the box plot does seem to support this hypothesis. Ideal diamonds, the highest cut, has the lowest median carat.

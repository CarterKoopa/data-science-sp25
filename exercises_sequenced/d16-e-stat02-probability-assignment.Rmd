...
-   What value of `fr` did you predict?
    -   A frequency of 50% would be the case in a perfectly standard distribution.
-   Did your prediction match your calculation?
    -   Depending on the specific run, the frequency tens to be slightly higher or lower than a perfect 50%, averaging somewhere around +/- 2%.
...
-   What was your `fr` prediction in **q1**? How does `p0` compare?
    -   The prediction matched as both values are 0.5

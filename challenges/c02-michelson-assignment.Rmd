...
-   I chose this graph to determine if distinctiveness of the
    measurement had an impact, on average, of the accuracy.

-   Overall, there is fairly little variation between the mean velocity
    in a vacuum between the various distinctiveness of measurements. In
...
-   There does not seem to be more standard deviation between the
    distinctness levels suggesting that the distinctiveness doesn't

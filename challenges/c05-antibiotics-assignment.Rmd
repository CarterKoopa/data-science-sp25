...
```{r q1.2, fig.width=12, fig.height=10}
# WRITE YOUR CODE HERE
df_antibiotics_long %>% 
...
-   Which of your visuals above (1 through 5) is **most effective** at helping to answer this question?
    ...
    -   I found a combination of my second and third visual the most effective at answering this question. Visual 5 was also helpful for gram strain.
...
-   Why?
    ...
    -   Visual 5 was helpful by showcasing aggregate trends across the gram data.
